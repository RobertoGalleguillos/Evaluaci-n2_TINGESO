...
function EstudiantesConCuotasComponent() {
  ...
  const handleSelectEstudiante = (estudiante) => {
    ...
    navigate(`/ver-cuotas/${estudiante.rut}`);
  };
    ...
    <div className="home">
      ...
      <Styles>
        <h1 className="text-center">
          <b>Estudiantes con cuotas generadas</b>
        </h1>
        <div className="f">
            ...
            <tbody>
              {estudiantes.map((estudiante) => (
                <tr key={estudiante.rut}>
                  ...
                  <td>
                    <Button className="boton" onClick={() => handleSelectEstudiante(estudiante)}>Ver cuotas</Button>
                  </td>
                </tr>
              ))}
            </tbody>
...
export default EstudiantesConCuotasComponent;
